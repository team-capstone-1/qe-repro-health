...
Mobile.tap(findTestObject('Article/btnNavbarArticle'), 0)

Mobile.tap(findTestObject('Article/1stArticle'), 0)

Mobile.verifyElementVisible(findTestObject('Article/detailArticle'), 0)
