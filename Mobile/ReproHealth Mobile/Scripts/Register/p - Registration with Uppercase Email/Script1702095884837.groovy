...
Mobile.setText(findTestObject('SignUp/fieldNameOnSignUp'), 'Qqq', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/SignUp/fieldEmailOnSignUp'), 0)

Mobile.setText(findTestObject('SignUp/fieldEmailOnSignUp'), 'Qqq3@gmail.com', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/SignUp/fieldPasswordOnSignUp'), 0)

Mobile.setText(findTestObject('SignUp/fieldPasswordOnSignUp'), 'Qqq111222', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/SignUp/fieldPassConfirmOnSignUp'), 0)

Mobile.setText(findTestObject('SignUp/fieldPassConfirmOnSignUp'), 'Qqq111222', 0)
